...
public class ChatRoomsAdapter extends RecyclerView.Adapter<ChatRoomsAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            ...
            message = (TextView) view.findViewById(R.id.chatroom_message);
            timestamp = (TextView) view.findViewById(R.id.chatroom_timestamp);
            count = (TextView) view.findViewById(R.id.chatroom_count);
        }
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.single_chat_room, parent, false);
