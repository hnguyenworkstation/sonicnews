...
import me.hnguyenuml.spyday.Utils.ScreenUtils;

/**
 * Created by Hung Nguyen on 11/7/2016.
 */
...
public class UserProfileAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        final View view = LayoutInflater.from(context).inflate(R.layout.square_layout, parent, false);
